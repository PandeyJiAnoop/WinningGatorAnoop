...
public class Banner implements Serializable {
    ...
    public static com.akp.winninggator.entity.Banner createobjectFromJson(String json) {
        Gson gson = new Gson();
        Type type = new TypeToken<Banner>() {
        }.getType();
        return gson.fromJson(json, type);
    ...
    public static String createjsonFromObject(com.akp.winninggator.entity.Banner banner) {
        Gson gson = new Gson();
        Type type = new TypeToken<Banner>() {
        }.getType();
