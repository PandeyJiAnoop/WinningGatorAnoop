...
import com.akp.winninggator.SlidingMenu.ReferEarnScreen;
import com.akp.winninggator.SlidingMenu.ReferralPersonList;
import com.akp.winninggator.SlidingMenu.SupportScreen;
import com.akp.winninggator.SlidingMenu.TermsConditions;
...
public class dashboard extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    TextView tvOnee, tvtwo, tvthree, tvfour, tvfive, ntvfive,ntvsix,tvthrees,tv_fundHistory;
    EditText edt_amount;
    private AlertDialog alertDialog2;

    TextView txt_username,txt_mobile,tv_change_password,tv_Profile,tvWallet,tvAvailbleBalance,game_limit_tv,game_rule_tv,tv_privacy_policy,tv_support,tv_withdrawlHistory,tv_referral;
    ...
    double amount = 0;
    TextView tvOne,tvOnee1,tvtwo1,tvthree1,tvfour1,tvfive1,tvsix1,x_value;
    ...
    private static final int SPLASH_TIME_OUT1 = 60000;
    ...
    TextView tvTotal1,tvTotal,withdraw_tv,withdraw_tv1,tv_terms;
    ...
    String gameId;
    private String final_amount,final_amount1;
    //initialisations
    Runnable mTicker5,mTicker7,mTickerdummy;
...
//    private int APIspeed =0;
    ...
    TextView userTv,userTv1,userTv2,referral_tv;
    ...
    Handler handler,handlera,handlera1;
    FloatIncrementRunnable runnable;
    FloatIncrementRunnable1 runnable1;

    TextView flew_tv,blink_tv;
    private float get_guna;
    private float get_guna1;



    int Endprogresscount=1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blink_tv = findViewById(R.id.blink_tv);
...
//        contactUs();
        ...
        blink_tv.setText("Place Your BET");
        timerTextView.setVisibility(View.VISIBLE);


        // adding the color to be shown
        ObjectAnimator animator = ObjectAnimator.ofInt(blink_tv, "backgroundColor", Color.BLUE, Color.RED);
    ...
    private void findViewByIds() {
        ...
        tv_referral= findViewById(R.id.tv_referral);
...
//        srl_refresh= findViewById(R.id.srl_refresh);
        ...
        ntvfive = findViewById(R.id.ntvfive);
        ntvsix = findViewById(R.id.ntvsix);
        ...
        tvOne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ntvfive.setTextColor(Color.WHITE);
                ntvsix.setTextColor(Color.WHITE);
                tvTotal.setText(tv_qty.getText().toString()+".00 INR");
            }
        });
        ...
        ntvfive.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tv_qty.setText("5000");
                tvOne.setTextColor(Color.WHITE);
                ...
                tvthree.setTextColor(Color.WHITE);
                tvfour.setTextColor(Color.WHITE);
                ntvfive.setTextColor(Color.RED);
                ntvsix.setTextColor(Color.WHITE);
                tvTotal.setText(tv_qty.getText().toString()+".00 INR");
            }
        });

        ntvsix.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tv_qty.setText("9999");
                tvOne.setTextColor(Color.WHITE);
...
//        });
        ...
        tvOnee1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tvfive1.setTextColor(Color.WHITE);
                tvsix1.setTextColor(Color.WHITE);
        ...
        tvfive1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tv_qty1.setText("5000");
                tvOnee1.setTextColor(Color.WHITE);
                tvtwo1.setTextColor(Color.WHITE);
                tvthree1.setTextColor(Color.WHITE);
                tvfour1.setTextColor(Color.WHITE);
                tvfive1.setTextColor(Color.RED);
                tvsix1.setTextColor(Color.WHITE);
                tvTotal1.setText(tv_qty1.getText().toString()+".00 INR");
            }
        });

        tvsix1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tv_qty1.setText("9999");
                tvOnee1.setTextColor(Color.WHITE);
                tvtwo1.setTextColor(Color.WHITE);
                tvthree1.setTextColor(Color.WHITE);
                tvfour1.setTextColor(Color.WHITE);
                tvfive1.setTextColor(Color.WHITE);
                tvsix1.setTextColor(Color.RED);
                tvTotal1.setText(tv_qty1.getText().toString()+".00 INR");
            }
        });
        ...
        bet_ll1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AddBetAPI1(gameId,"2",tv_qty1.getText().toString());
            ...
            public void onResponse(String response) { Log.d("Game_SlotDetailsAPI","sadaf"+response);
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        endValue = Float.parseFloat(jsonObject2.getString("FlewTime"));
                        endValue1 = Float.parseFloat(jsonObject2.getString("FlewTime"));
...
//        auto refersh layout for gameId
        ...
        mTicker = new Runnable() {
            ...
            public void run() {
                ...
                // user interface interactions and updates on screen
                mHandler.postDelayed(mTicker, 2000);
            }
        };
        mHandler.postDelayed(mTicker, 2000);
...
//        auto refersh layout for gameId
        final Handler mHandlerdummy = new Handler();
        mTickerdummy = new Runnable() {
            @Override
            public void run() {
                if (dummyprogresscount == 1){
                    DummyWithdraw(game_number_tv.getText().toString());
                    dummyprogresscount++;
                }
                else {
                ...
                // user interface interactions and updates on screen
                mHandlerdummy.postDelayed(mTickerdummy, 12000);
            }
        };
        mHandler.postDelayed(mTickerdummy, 12000);
...
//        auto refersh layout for gameId
        ...
        mTicker5 = new Runnable() {
            ...
            public void run() {
                ...
                // user interface interactions and updates on screen
                mHandler5.postDelayed(mTicker5, 4000);
            }
        };
        mHandler5.postDelayed(mTicker5, 4000);
...
//                startActivity(new Intent(dashboard.this, dashboard.class));
    ...
    void navigationItemClicks() {
        tv_Dashboard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(dashboard.this, WinningBetDashboard.class));
                drawer.closeDrawers();
            }
        });
        ...
        referral_tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(dashboard.this, ReferEarnScreen.class));
                drawer.closeDrawers();
            }
        });
        ...
        tv_terms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(dashboard.this, TermsConditions.class));
                drawer.closeDrawers();
            }
        });
        ...
        tv_referral.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        editor.clear();
                        editor.commit();
                        startActivity(new Intent(dashboard.this,splashscrn.class));
                    }
                });
...
/*
    private void CounterStart(float svalue) {
        if (game_number_tv.getText().toString().equalsIgnoreCase("")){
            Toast.makeText(getApplicationContext(),"one",Toast.LENGTH_LONG).show();
//            GetRealTime_GameStatusAPI(gameId);
            handler = new Handler();
            runnable = new FloatIncrementRunnable(handler, game_number_tv, svalue, endValue,500);
            runnable.start();
        }
        else {
            handler = new Handler();
            runnable = new FloatIncrementRunnable(handler, game_number_tv, get_guna, endValue,500);
            runnable.start();
...
//                            }, 2000);
    ...
    public void AddBetAPI1(String s_game_id,String s_betid,String s_bet_amount) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Api_Urls.Game_AddBetOnGameAPI, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) { Log.d("Game_AddBetOnGameAPI","sadaf"+response);
                try {
                    ...
                    if (jsonObject.getString("Status").equalsIgnoreCase("true")){
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            tvOnee1.setClickable(false);
                            tvtwo1.setClickable(false);
                            tvthree1.setClickable(false);
                            tvfour1.setClickable(false);
                            withdraw_bet_ll1.setVisibility(View.VISIBLE);
                            withdraw_bet_ll1.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    tvOnee1.setClickable(true);
                                    tvtwo1.setClickable(true);
                                    tvthree1.setClickable(true);
                                    tvfour1.setClickable(true);
                                    GetGameWithdrawalAPI1(GetPKID,final_amount1,gameId,"2",game_number_tv.getText().toString());
                                }
                            });
                        ...
                        bet_ll1.setVisibility(View.VISIBLE);
                        cancel_bet_ll1.setVisibility(View.GONE);
                        withdraw_bet_ll1.setVisibility(View.GONE);
                    }
                }catch (JSONException e) {
                    e.printStackTrace();
                }
                            ...
                            if (jsonObject2.getString("Msg").equalsIgnoreCase("Withdrawal Successfully.")) {
                                ...
                                bet_ll.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        View layout = inflater.inflate(R.layout.custom_toast, (ViewGroup) dashboard.this.findViewById(R.id.custom_toast_layout));
                                        TextView tv = (TextView) layout.findViewById(R.id.txtvw);
                                        tv.setText("Bid Added Successfully\nWaiting for Next Round....");
                                        Toast toast = new Toast(dashboard.this);
                                        toast.setGravity(Gravity.TOP, 0, 100);
                                        toast.setDuration(Toast.LENGTH_LONG);
                                        toast.setView(layout);
...
//                        Toast.makeText(dashboard.this,jsonObject.getString("Message"),Toast.LENGTH_LONG).show();
    ...
    public void GetGameWithdrawalAPI1(String pid,String wamount,String gameid,String betid,String betgunna) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Api_Urls.GameWithdrawalAPI, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) { Log.d("GameWithdrawalAPI","sadaf"+response);
                try {
...
//                        Toast.makeText(dashboard.this,gameId,Toast.LENGTH_LONG).show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                Log.d("RealTime_GameStatusAPIp","sadaf"+params);
                return params;
            }
        };
        stringRequest.setRetryPolicy(new DefaultRetryPolicy(
...
//                    vh.tv1.setTextColor(ContextCompat.getColor(context, R.color.purple));
            ...
            if (arrayList.get(i).get("BetGuna") == null){
                ...
                else if (Double.parseDouble(arrayList.get(i).get("BetGuna")) > 4){
                    vh.tv1.setTextColor(ContextCompat.getColor(context, R.color.pink));
                }
                else {
//                    vh.tv1.setTextColor(ContextCompat.getColor(context, R.color.purple));
            ...
            public void onResponse(String response) { Log.d("RealTimeGuna_Showfddsfs","sadaf"+response);
                try {
                    ...
                    if (jsonObject.getString("Status").equalsIgnoreCase("true")){
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            JSONObject jsonObject2 = jsonArray.getJSONObject(i);
                            get_guna= Float.parseFloat(jsonObject2.getString("BetGuna"));
                            if (jsonObject2.getString("GameId").equalsIgnoreCase(gameId)){
                                game_number_tv.setText(jsonObject2.getString("BetGuna"));

                                if (get_guna == 0.0){
//                                    Toast.makeText(getApplicationContext(),"one"+get_guna,Toast.LENGTH_LONG).show();
//            GetRealTime_GameStatusAPI(gameId);
                                    handlera = new Handler();
                                    runnable = new FloatIncrementRunnable(handlera, game_number_tv, 1.0f, endValue,500);
                                    runnable.start();
                                }
                                else {
//                                    Toast.makeText(getApplicationContext(),"two",Toast.LENGTH_LONG).show();
                                    handlera = new Handler();
                                    runnable = new FloatIncrementRunnable(handlera, game_number_tv, get_guna, endValue,500);
                                    runnable.start();
                                }


                                Log.d("RealTimeGuna_Showfname","sadaf"+get_guna);
                            }
                        }
                    }
                    else {
    ...
    public void RealTimeGuna_ShowAPI1(String g_id) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Api_Urls.RealTimeGuna_Show, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) { Log.d("RealTimeGuna_Showfddsfs","sadaf"+response);
                try {
                    ...
                    if (jsonObject.getString("Status").equalsIgnoreCase("true")){
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            JSONObject jsonObject2 = jsonArray.getJSONObject(i);
                            get_guna1= Float.parseFloat(jsonObject2.getString("BetGuna"));
                            if (jsonObject2.getString("GameId").equalsIgnoreCase(gameId)){
                                game_number_tv.setText(jsonObject2.getString("BetGuna"));
...
//                                    Toast.makeText(getApplicationContext(),"one"+get_guna,Toast.LENGTH_LONG).show();
//            GetRealTime_GameStatusAPI(gameId);
                                    handlera1 = new Handler();
                                    runnable1 = new FloatIncrementRunnable1(handlera1, game_number_tv, 1.0f, endValue1,500);
                                    runnable1.start1();
                                }
                                else {
//                                    Toast.makeText(getApplicationContext(),"two",Toast.LENGTH_LONG).show();
                                    handlera1 = new Handler();
                                    runnable1 = new FloatIncrementRunnable1(handlera1, game_number_tv, get_guna1, endValue1,500);
                                    runnable1.start1();
                                }
...
//                    sliderView.setDescription("खुशियां  हो  जहाँ  ");
    ...
    public class FloatIncrementRunnable implements Runnable {
        private final Handler handlercount;
        ...
        public FloatIncrementRunnable(Handler handlercount, TextView textView, float startValue, float endValue,int d_speed) {
        ...
        public void run() {
            if (started) {
                if (tv_qty.getText().toString().equalsIgnoreCase("")) {
                    ...
                    x_value.setVisibility(View.VISIBLE);
                    blink_tv.setText("Add Bet Before Game Start..");
                    Double gameno = Double.valueOf(game_number_tv.getText().toString());
                    Double tvtotal = Double.valueOf(tv_qty.getText().toString());
                    Log.d("win_amount", "" + gameno + tvtotal);
                    Double win_amount = (gameno * tvtotal);
                    ...
                    if (d_value < endValue) {
                        d_value += 0.044;
//                    d_value += increment;
                        handlercount.postDelayed(this, 150);
//                    handler.postDelayed(this, APIspeed);
//                if (ApplyBet == null){
//                }
//                else {
//                    if (ApplyBet.equalsIgnoreCase("one")){
//                        textView.setText(String.valueOf(d_value));
//                        x_value.setVisibility(View.VISIBLE);
//                        Double gameno= Double.valueOf(game_number_tv.getText().toString());
//                        Double tvtotal= Double.valueOf(tv_qty.getText().toString());
...
//                        x_value.setVisibility(View.VISIBLE);
//                        Double gameno= Double.valueOf(game_number_tv.getText().toString());
//                        Double tvtotal= Double.valueOf(tv_qty1.getText().toString());
//                        Log.d("win_amount",""+gameno+tvtotal);
//                        Double win_amount=(gameno*tvtotal);
//                        final_amount1= String.valueOf(win_amount);
//                        withdraw_tv1.setText(final_amount1);
//                        Log.d("win_amount1",""+win_amount);
//                        if (d_value < endValue) {
//                            d_value += 0.044;
////                    d_value += increment;
...
//                    }
    ...
    public class FloatIncrementRunnable1 implements Runnable {
        private final Handler handlercount1;
        private final TextView textView1;
        private final float startValue1;
        private final float endValue1;
        //        private final float increment;
        private double d_value1;
        private boolean started1;
        private int d_speed1;

        public FloatIncrementRunnable1(Handler handlercount1, TextView textView1, float startValue1, float endValue1,int d_speed1) {
            this.handlercount1 = handlercount1;
            this.textView1 = textView1;
            this.startValue1 = startValue1;
            this.endValue1 = endValue1;
//            this.increment = increment;
            this.d_value1 = startValue1;
            this.d_speed1 = d_speed1;
        }

        @Override
        public void run() {
            if (started1) {
                if (tv_qty1.getText().toString().equalsIgnoreCase("")){
                }
                else {
                    textView1.setText(String.valueOf(d_value1));
                    x_value.setVisibility(View.VISIBLE);
                    blink_tv.setText("Add Bet Before Game Start..");
                    Double gameno1 = Double.valueOf(game_number_tv.getText().toString());
                    Double tvtotal1 = Double.valueOf(tv_qty1.getText().toString());
                    Log.d("win_amount", "" + gameno1 + tvtotal1);
                    Double win_amount1 = (gameno1 * tvtotal1);
                    final_amount1 = String.valueOf(win_amount1);
                    withdraw_tv1.setText(final_amount1);
                    Log.d("win_amount1", "" + win_amount1);
                    if (d_value1 < endValue1) {
                        d_value1 += 0.044;
//                    d_value += increment;
                        handlercount1.postDelayed(this, 150);
//                    handler.postDelayed(this, APIspeed);
                    } else {
                        EndGameAPI();
                    }
        ...
        public void start1() {
            if (!started1) {
                started1 = true;
                handlercount1.post(this);
            }
        }

        public void stop1() {
            started1 = false;
            handlercount1.removeCallbacks(this);
        }
    }
    ...
    //Insert gunna in top view
    public void DummyWithdraw(String betgunna) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Api_Urls.DummyWithdrawalAPI, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) { Log.d("DummyWithdrawalAPI","sadaf"+response);
                try {
                    JSONObject jsonObject = new JSONObject(response);
                    JSONArray jsonArray = jsonObject.getJSONArray("Response");
                    for (int i = 0; i < jsonArray.length(); i++) {
...
//                        Toast.makeText(dashboard.this,gameId,Toast.LENGTH_LONG).show();
    ...
    public void GameStartUpdateStatusAPI() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Api_Urls.GameStart_UpdateStatusAPI, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) { Log.d("gameupdate","sadaf"+response);
                try {
                    JSONObject jsonObject = new JSONObject(response);
                    if (jsonObject.getString("Status").equalsIgnoreCase("true")){
                        JSONArray jsonArray = jsonObject.getJSONArray("Response");
...
//    countdown timmer funcationality
private void startTimer() {
    ...
    private void updateTimerText() {
        ...
        timerTextView.setText("("+timeLeft+")left");
    }
