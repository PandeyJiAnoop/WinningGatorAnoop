...
public class Demo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final float endValue = 5f;
        final float increment = 0.1f; // adjust this value to change the speed of the animation

        final TextView textView = findViewById(R.id.textView);

        final Handler handler = new Handler();
        final FloatIncrementRunnable runnable = new FloatIncrementRunnable(handler, textView, startValue, endValue, increment,500);
        runnable.start();
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                runnable.stop();
                textView.setText(String.format("%.1f", startValue));
            }
        });
...
//    final float increment = 0.11f; // adjust this value to change the speed of the animation
//    Handler handler;
...
//        new Handler().postDelayed(new Runnable() {
//            @Override
//            public void run() { RealTimeGuna_ShowAPI(gameId);
...
//            handler = new Handler();
//            runnable = new FloatIncrementRunnable(handler, game_number_tv, startValue, endValue, increment);
//            runnable.start();
//
//
//
...
//                            runnable.stop();
//                            game_number_tv.setText(String.format("%.1f", startValue));
...
//        private int speed;
//
//        public FloatIncrementRunnable(Handler handler, TextView textView, double startValue, double endValue, double increment) {
//            this.handler = handler;
//            this.textView = textView;
//            this.startValue = startValue;
//            this.endValue = endValue;
